...
- `/root/openclaw/src/events/README.md` - Full documentation
- `/root/openclaw/src/events/INTEGRATION.md` - Integration guide
- `/root/openclaw/src/events/example-initialization.ts` - Code examples
