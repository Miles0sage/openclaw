...
async def execute_with_ide(
    ...
    for iteration in range(max_iterations):
        ...
        try:
            # Call Gemini with conversation + tools
            payload = {
...
if __name__ == "__main__":
    ...
    async def test():
        ...
        result = await execute_with_ide(
            prompt="Read the file /root/openclaw/bet_tracker.py and tell me how many actions it supports. List them.",
            job_id="ide-test-001",
            phase="test",
        )
        ...
        result2 = await execute_with_ide(
            prompt=(
                ...
                "Then write a brief summary to /root/openclaw/data/betting/ide_test_report.md "
