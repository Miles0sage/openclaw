...
*/5 * * * * /root/openclaw/scripts/health-check.sh >> /root/openclaw/logs/health-cron.log 2>&1
# Log rotation daily at midnight
0 0 * * * /root/openclaw/scripts/rotate-logs.sh >> /root/openclaw/logs/rotate-cron.log 2>&1
# Daily cost report at 9 AM
0 9 * * * /root/openclaw/scripts/daily-report.sh >> /root/openclaw/logs/report-cron.log 2>&1
...
source <(grep -E '^(TELEGRAM_BOT_TOKEN|TELEGRAM_USER_ID)=' /root/openclaw/.env 2>/dev/null || true)

if [ -z "${TELEGRAM_USER_ID:-}" ]; then
    echo ""
    echo "  WARNING: TELEGRAM_USER_ID is not set in /root/openclaw/.env"
    echo ""
    ...
    echo "    4. Add to /root/openclaw/.env:"
...
echo ""
echo "Logs:"
echo "  - Health:  /root/openclaw/logs/health.log"
echo "  - Cron:    /root/openclaw/logs/health-cron.log"
echo "  - Rotate:  /root/openclaw/logs/rotate-cron.log"
echo "  - Report:  /root/openclaw/logs/report-cron.log"
