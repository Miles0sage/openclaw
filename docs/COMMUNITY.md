...
- **Community Email**: `hello@overseerclaw.uk`
...
- Hosted gateway at `gateway.overseerclaw.uk` (white-labeled domain option at +$10)
...
- [ ] Deploy landing page at `overseerclaw.uk`
...
- [ ] Create blog subdirectory: `overseerclaw.uk/blog/`
...
1. **Today**: Register Twitter handle + set up email forwarding for `hello@overseerclaw.uk`
...
## Appendix A: Landing Page Copy (overseerclaw.uk)
