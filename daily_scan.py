...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("/root/openclaw/data/betting/scan.log", mode="a"),
    ],
)
...
def ensure_directories():
    ...
    Path("/root/openclaw/data/betting").mkdir(parents=True, exist_ok=True)
    Path("/root/openclaw/data/betting/daily_reports").mkdir(parents=True, exist_ok=True)
...
def save_report(dashboard: dict, nba: dict, crypto: dict):
    ...
    try:
        ...
        report_path = f"/root/openclaw/data/betting/daily_reports/{today}.json"
