...
def test_all_workflows():
    ...
    if passed == total:
        ...
        print("   - /root/openclaw/workflows/openclaw-agent-pipeline-monitor-v2.json")
        print("   - /root/openclaw/workflows/openclaw-cost-alert.json")
        print("   - /root/openclaw/workflows/openclaw-daily-digest.json")
