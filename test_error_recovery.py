...
class TestBackoffCalculation:
    ...
    def test_explicit_wait_time(self):
        ...
        backoff = _calculate_backoff(3, 100.0, policy)
        assert backoff == 100.0  # Uses explicit wait, not calculated backoff
    ...
    def test_jitter_adds_randomness(self):
        ...
        # All should be around 4.0 ± 10% = 3.6-4.4
        for backoff in backoffs:
            assert 3.5 < backoff < 4.5
