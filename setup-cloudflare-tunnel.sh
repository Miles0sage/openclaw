...
if [[ ! $TUNNEL_OK =~ ^[Yy]$ ]]; then
    ...
    echo ""
    echo "Common issues:"
    echo "  - OpenClaw gateway not running: cd /root/openclaw && python3 gateway.py &"
...
echo ""
echo "   Guide: /root/openclaw/CLOUDFLARE-TUNNEL-SETUP.md"
echo ""
echo -e "${BLUE}📚 Documentation:${NC}"
echo ""
echo "   Full guide:   cat /root/openclaw/CLOUDFLARE-TUNNEL-SETUP.md"
