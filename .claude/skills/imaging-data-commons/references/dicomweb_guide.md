...
**Warning from IDC documentation:** _"Google-hosted DICOM store may not contain the latest version of IDC data!"_ - Check during the weeks following a new release.
